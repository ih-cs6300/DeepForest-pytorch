...
parser.add_argument('--a', type=float, required=True, help='h-ca allometry constant')
parser.add_argument('--b', type=float, required=True, help='h-ca allometry constant')
